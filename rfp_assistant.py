...
# from scrapers.canadabuys import scrape_canadabuys # no API for this
# from scrapers.sasktenders import scrape_sasktenders # no API for this
...
async def search_opportunities(profile: CompanyProfile):
    ...
    scrapers = [fetch_alberta_opportunities, fetch_ariba_opportunities] #, scrape_sasktenders, scrape_canadabuys]
...
"""
    ...
    # return FileResponse(output_file, media_type='application/pdf', filename="rfp_response.pdf")
